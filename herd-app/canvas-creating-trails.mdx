...
<Frame>
  <img 
    src="/images/canvas-add-node.png" 
    alt="Initial Canvas view after creating a trail" 
    width="400"
    height="400"
  />
</Frame>
...
Once you have added a node, you can click on the new node to pull up the edit panel. Below is a quick visual overview of the panel:
