...
<Note>Creating trails is a fairly technical process. If you are not familiar with smart contracts then go to "herd.eco/trails" -> all trails, and try searching for a trail to build your app off of. Or reach out in [the Discord](https://discord.gg/NsfPWZZuKU) to get a Trailblazer to help you.</Note>
