...
<Note>
Creating trails can be a fairly technical process, and you'll need to exercise caution when building with contracts you aren't familiar with. Always try searching for an trail to build your app off of first, and reach out in [the Discord](https://discord.gg/NsfPWZZuKU) to get a Trailblazer to help you.
