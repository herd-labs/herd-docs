...
The Herd app is built as an collaborative terminal (explorer) with an agent (Sage) who exists on every page to help you find and understand the chain. You can watch the video below for an overview of memory and the overall app. 
