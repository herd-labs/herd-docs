...
<Note>The easiest way to integrate the API is to go to the trail overlook and copy [the Guidebook](../herd-trails/guidebook-llm-api) prompt/link. For debugging, you can also use the overlook to submit send/read requests, which will generate you example cURL and response results that you can prompt LLMs with.</Note>
