...
<Note>The easiest way to integrate the API is to go to the trail overlook and submit send/read requests. This will generate you example cURL and response results that are easier to prompt LLMs with.</Note>
