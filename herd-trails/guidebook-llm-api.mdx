...
After publishing a trail, you will be able to access the guidebook. This is an API for using a trail outside of Herd.
...
You can use this same prompt/link to generate automations, chatbots, or anything else 🙂

## Integrating the Trail API
...
You can also check out the [API docs](../api-reference/introduction) for more information.