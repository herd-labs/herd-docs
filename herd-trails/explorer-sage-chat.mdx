...
The Herd app is built as an explorer with an agent (Sage) who exists on every page to help you find and understand the chain. You can watch the video below for an overview of memory and the overall explorer app. If you haven't used an explorer like [Etherscan](https://etherscan.io) before, explorers in crypto are used to investigate smart contracts, wallets, and transactions. Our explorer uses an LLM to interpret each of these objects, to provide richer context alongside all the data. 
